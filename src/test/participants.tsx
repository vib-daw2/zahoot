...
const Participant = ({ name }: { name: string }) => {
    return (
        <motion.div
            ...
            className='flex z-[100] flex-col justify-center items-center p-4 bg-white rounded-lg border drop-shadow-md min-w-24'
        >
            <UserRound size={48} />
...
export default function Participants({ }: Props) {
    ...
    return (
        <div className='w-full h-screen flex flex-col justify-center items-center'>
            ...
            <motion.div variants={containerMotion} className='flex flex-row justify-center h-[45vh] p-2 overflow-hidden items-center max-w-[60%] flex-wrap gap-6 mt-4'>
