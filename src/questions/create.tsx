                ...
                <AnimatePresence>
                    {
                        questions.map((question, i) => (
                            <motion.div style={{ boxShadow, y }} key={question.question} id={question.question} className='flex relative flex-col gap-3 p-3 bg-white bg-opacity-75 rounded-lg border drop-shadow-lg w-full'>
